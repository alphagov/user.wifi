...
class session
{
    ...
    public function writeToDB()
    {
        ...
        $handle->bindValue(':startmin', strftime('%Y-%m-%d %h:%m:%s',$this->startTime-$window), PDO::PARAM_STR);
        $handle->bindValue(':startmax', strftime('%Y-%m-%d %h:%m:%s',$this->startTime+$window), PDO::PARAM_STR);
